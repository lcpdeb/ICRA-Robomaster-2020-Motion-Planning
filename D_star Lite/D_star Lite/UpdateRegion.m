...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if all(side=='R')
    if (F1.last_name=="禁止射击区"||F1.last_name=="禁止移动区"||F1.last_name=="蓝方回血区") && (F1.name~="禁止射击区"&&F1.name~="禁止移动区"&&F1.name~="蓝方回血区")
        new_free=[new_free
                  F1_obstacle_cover];
    end
    if (F1.last_name~="禁止射击区"&&F1.last_name~="禁止移动区"&&F1.last_name~="蓝方回血区") && (F1.name=="禁止射击区"||F1.name=="禁止移动区"||F1.name=="蓝方回血区")
    ...
    if (F2.last_name=="禁止射击区"||F2.last_name=="禁止移动区"||F2.last_name=="蓝方回血区") && (F2.name~="禁止射击区"&&F2.name~="禁止移动区"&&F2.name~="蓝方回血区")
        new_free=[new_free
                  F2_obstacle_cover];
    end
    if (F2.last_name~="禁止射击区"&&F2.last_name~="禁止移动区"&&F2.last_name~="蓝方回血区") && (F2.name=="禁止射击区"||F2.name=="禁止移动区"||F2.name=="蓝方回血区")
    ...
    if (F3.last_name=="禁止射击区"||F3.last_name=="禁止移动区"||F3.last_name=="蓝方回血区") && (F3.name~="禁止射击区"&&F3.name~="禁止移动区"&&F3.name~="蓝方回血区")
        new_free=[new_free
                  F3_obstacle_cover];
    end
    if (F3.last_name~="禁止射击区"&&F3.last_name~="禁止移动区"&&F3.last_name~="蓝方回血区") && (F3.name=="禁止射击区"||F3.name=="禁止移动区"||F3.name=="蓝方回血区")
    ...
    if (F4.last_name=="禁止射击区"||F4.last_name=="禁止移动区"||F4.last_name=="蓝方回血区") && (F4.name~="禁止射击区"&&F4.name~="禁止移动区"&&F4.name~="蓝方回血区")
        new_free=[new_free
                  F4_obstacle_cover];
    end
    if (F4.last_name~="禁止射击区"&&F4.last_name~="禁止移动区"&&F4.last_name~="蓝方回血区") && (F4.name=="禁止射击区"||F4.name=="禁止移动区"||F4.name=="蓝方回血区")
    ...
    if (F5.last_name=="禁止射击区"||F5.last_name=="禁止移动区"||F5.last_name=="蓝方回血区") && (F5.name~="禁止射击区"&&F5.name~="禁止移动区"&&F5.name~="蓝方回血区")
        new_free=[new_free
                  F5_obstacle_cover];
    end
    if (F5.last_name~="禁止射击区"&&F5.last_name~="禁止移动区"&&F5.last_name~="蓝方回血区") && (F5.name=="禁止射击区"||F5.name=="禁止移动区"||F5.name=="蓝方回血区")
    ...
    if (F6.last_name=="禁止射击区"||F6.last_name=="禁止移动区"||F6.last_name=="蓝方回血区") && (F6.name~="禁止射击区"&&F6.name~="禁止移动区"&&F6.name~="蓝方回血区")
        new_free=[new_free
                  F6_obstacle_cover];
    end
    if (F6.last_name~="禁止射击区"&&F6.last_name~="禁止移动区"&&F6.last_name~="蓝方回血区") && (F6.name=="禁止射击区"||F6.name=="禁止移动区"||F6.name=="蓝方回血区")
...
elseif (side=='B')
    if (F1.last_name=="禁止射击区"||F1.last_name=="禁止移动区"||F1.last_name=="红方回血区") && (F1.name~="禁止射击区"&&F1.name~="禁止移动区"&&F1.name~="红方回血区")
        new_free=[new_free
                  F1_obstacle_cover];
    end
    if (F1.last_name~="禁止射击区"&&F1.last_name~="禁止移动区"&&F1.last_name~="红方回血区") && (F1.name=="禁止射击区"||F1.name=="禁止移动区"||F1.name=="红方回血区")
    ...
    if (F2.last_name=="禁止射击区"||F2.last_name=="禁止移动区"||F2.last_name=="红方回血区") && (F2.name~="禁止射击区"&&F2.name~="禁止移动区"&&F2.name~="红方回血区")
        new_free=[new_free
                  F2_obstacle_cover];
    end
    if (F2.last_name~="禁止射击区"&&F2.last_name~="禁止移动区"&&F2.last_name~="红方回血区") && (F2.name=="禁止射击区"||F2.name=="禁止移动区"||F2.name=="红方回血区")
    ...
    if (F3.last_name=="禁止射击区"||F3.last_name=="禁止移动区"||F3.last_name=="红方回血区") && (F3.name~="禁止射击区"&&F3.name~="禁止移动区"&&F3.name~="红方回血区")
        new_free=[new_free
                  F3_obstacle_cover];
    end
    if (F3.last_name~="禁止射击区"&&F3.last_name~="禁止移动区"&&F3.last_name~="红方回血区") && (F3.name=="禁止射击区"||F3.name=="禁止移动区"||F3.name=="红方回血区")
    ...
    if (F4.last_name=="禁止射击区"||F4.last_name=="禁止移动区"||F4.last_name=="红方回血区") && (F4.name~="禁止射击区"&&F4.name~="禁止移动区"&&F4.name~="红方回血区")
        new_free=[new_free
                  F4_obstacle_cover];
    end
    if (F4.last_name~="禁止射击区"&&F4.last_name~="禁止移动区"&&F4.last_name~="红方回血区") && (F4.name=="禁止射击区"||F4.name=="禁止移动区"||F4.name=="红方回血区")
    ...
    if (F5.last_name=="禁止射击区"||F5.last_name=="禁止移动区"||F5.last_name=="红方回血区") && (F5.name~="禁止射击区"&&F5.name~="禁止移动区"&&F5.name~="红方回血区")
        new_free=[new_free
                  F5_obstacle_cover];
    end
    if (F5.last_name~="禁止射击区"&&F5.last_name~="禁止移动区"&&F5.last_name~="红方回血区") && (F5.name=="禁止射击区"||F5.name=="禁止移动区"||F5.name=="红方回血区")
    ...
    if (F6.last_name=="禁止射击区"||F6.last_name=="禁止移动区"||F6.last_name=="红方回血区") && (F6.name~="禁止射击区"&&F6.name~="禁止移动区"&&F6.name~="红方回血区")
        new_free=[new_free
                  F6_obstacle_cover];
    end
    if (F6.last_name~="禁止射击区"&&F6.last_name~="禁止移动区"&&F6.last_name~="红方回血区") && (F6.name=="禁止射击区"||F6.name=="禁止移动区"||F6.name=="红方回血区")
