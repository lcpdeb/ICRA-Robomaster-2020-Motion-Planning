...
%%
load(fullfile('D:','OneDrive - The Ohio State University','ICRA-Robomaster-2020-Motion-Planning','D_star_Lite cpp','D_start_Lite','ccpp.txt'))
...
load(fullfile('D:','OneDrive - The Ohio State University','ICRA-Robomaster-2020-Motion-Planning','D_star_Lite_cpp','D_start_Lite','pathcpp.txt'))
plot(pathcpp(:,1),pathcpp(:,2),'LineWidth',1,'Color','k');
load(fullfile('D:','OneDrive - The Ohio State University','ICRA-Robomaster-2020-Motion-Planning','D_star_Lite_cpp','D_start_Lite','rhscpp.txt'))